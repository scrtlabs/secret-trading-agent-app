    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Secret Network Trading Agent</h1>
          <p className="text-slate-600">Chat with an AI agent to convince it to execute trades on Secret Network</p>
        </div>
        ...
        <div className="text-center mt-12 text-slate-500 text-sm">
          ...
          <p className="mt-1">Tip: Mention "Kanye" in your messages for some inspiration! 🎤</p>
        </div>
      </div>
    </div>
  )
